...
$uri = URI::SmartURI->new("ldap://host/dn=base?cn,sn?sub?objectClass=*");
...
$uri = URI::SmartURI->new("ldap://LDAP-HOST:389/o=University%20of%20Michigan,c=US?postalAddress?base?ObjectClass=*?FOO=Bar,bindname=CN%3DManager%CO%3dFoo");
...
$uri = URI::SmartURI->new("ldaps://host/dn=base?cn,sn?sub?objectClass=*");
...
$uri = URI::SmartURI->new("ldapi://%2Ftmp%2Fldap.sock/????x-mod=-w--w----");
