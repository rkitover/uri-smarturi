...
$u = URI::SmartURI->new("data:,A%20brief%20note");
...
$u = URI::SmartURI->new("data:image/gif;base64,");
...
$u = URI::SmartURI->new("data:text/plain;charset=iso-8859-7,%be%fg%be");  # %fg
print "not " unless $u->data eq "\xBE%fg\xBE";
print "ok 7\n";

$u = URI::SmartURI->new("data:application/vnd-xxx-query,select_vcount,fcol_from_fieldtable/local");
...
# Test automatic selection of URI::SmartURI/BASE64 encoding
$u = URI::SmartURI->new("data:");
$u->data("");
